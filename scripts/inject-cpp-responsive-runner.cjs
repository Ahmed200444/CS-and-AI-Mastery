...
const tag='<script src="/assets/cpp-runner-ui-worker.js?v=20260809-3"></script>';
let changed=0;
...
console.log(`Injected corrected C++ toolchain controller into ${changed} course page(s); verified ${files.length}.`);
