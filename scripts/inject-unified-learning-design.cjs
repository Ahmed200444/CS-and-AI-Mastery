...
const heroCssRoot = 'assets/hero-polish.css';
const heroJsRoot = 'assets/hero-polish.js';
...
const heroCssCourse = '../assets/hero-polish.css';
...
if (fs.existsSync(coursesDir)) {
  ...
  for (const file of files) {
    ...
    const html = inject(fs.readFileSync(p, 'utf8'), cssRelCourse, jsRelCourse, productCssCourse, productJsCourse, liveCssCourse, liveJsCourse, heroCssCourse, heroJsCourse);
