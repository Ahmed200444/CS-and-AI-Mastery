...
const block='<!-- csai-studycore-export:start -->\n<script src="assets/studycore-export.js?v=20260822-v567" defer></script>\n<!-- csai-studycore-export:end -->';
...
if(!final.includes('assets/studycore-export.js?v=20260822-v567'))throw new Error('StudyCore export asset missing from index.');
