...
console.log('Course UX predeploy verification passed: 54 guarded pages, no predict-output UI, strict language-flexible selector scope, and C++/Dual assessment switching hooks present.');
